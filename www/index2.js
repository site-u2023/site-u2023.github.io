...
<html lang="en">
  <head>
    ...
    <meta name="theme-color" content="#43b0e8">

    <script src="config2.js"></script>

    <!-- Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-35ERS2K9TJ"></script>
    <script>
  ...
  <body onload="init()">
    ...
    <!-- Settings Import/Export Bar (直書き) -->
    <div id="settings-bar">
        <div class="settings-bar-content">
            <div class="left-section">
                <div id="asu-status-container" class="asu-status">
                    ...
                    <a id="asu-server-link" href="https://sysupgrade.openwrt.org/" target="_blank" rel="noopener noreferrer" class="asu-link">🔗</a>
                </div>
      ...
      <div>
        ...
        <div id="images" class="hide">
          ...
          <div>
            ...
            <!-- extended-build-info はJSで動的に挿入される -->

            <div class="row">
              <div id="asu" class="hide" style="width: 100%">
                <!-- カスタム パッケージセレクター -->
                <details id="custom-packages-details">
                    <summary>
                ...
                <!-- カスタム スクリプト設定 -->
                <details id="custom-scripts-details">
                    <summary>
        ...
        <div id="footer">
          ...
          <span
            ><a
              href="https://forum.openwrt.org/t/builder-custom-firmware-selector-openwrt-org"
          ...
          |
          <span
            ><a href="https://github.com/site-u2023/site-u2023.github.io" target="_blank"
              >OFS <span id="ofs-version">site-u2023.github.io</span></a
            ></span
          >
        </div>
      </div>
