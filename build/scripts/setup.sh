...
[ $M -ge 3072 ]&&R=16777216 W=16777216 TR="4096 262144 16777216" TW="4096 262144 16777216" CT=262144 NB=5000 SC=16384
[ $M -ge 1536 -a $M -lt 3072 ]&&R=8388608 W=8388608 TR="4096 131072 8388608" TW="4096 131072 8388608" CT=131072 NB=2500 SC=8192
[ $M -ge 512 -a $M -lt 1536 ]&&R=4194304 W=4194304 TR="4096 65536 4194304" TW="4096 65536 4194304" CT=65536 NB=1000 SC=4096
[ $M -lt 512 ]&&R=1048576 W=1048576 TR="4096 32768 1048576" TW="4096 32768 1048576" CT=32768 NB=500 SC=2048
[ $P -gt 4 ]&&NB=$((NB*2)) SC=$((SC*2))
[ $P -gt 2 -a $P -le 4 ]&&NB=$((NB*3/2)) SC=$((SC*3/2))
cat>$C<<F
net.core.rmem_max=$R
net.core.wmem_max=$W
...
E
chmod +x /etc/init.d/netopt
/etc/init.d/netopt enable
}
