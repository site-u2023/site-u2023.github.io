...
const translations = {
    ja: {
        ...
        OpenWrtCustom: 'ファームウェアセレクター (カスタム)',
        firmwareDownload: 'デバイス用のOpenWrカスタムファームウェアをダウンロード',
    ...
    en: {
        ...
        OpenWrtCustom: 'Firmware Selector (Custom)',
        firmwareDownload: 'Download OpenWrt custom firmware for your device',
